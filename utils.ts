...
import type { LicensingConfig } from '@story-protocol/core-sdk' // ✅ fixed here
...
const privateKey: Address = process.env.NEXT_PUBLIC_WALLET_PRIVATE_KEY?.startsWith('0x') 
  ? process.env.NEXT_PUBLIC_WALLET_PRIVATE_KEY as Address 
  : `0x${process.env.NEXT_PUBLIC_WALLET_PRIVATE_KEY}` as Address;
